...
@section('script')
    ...
    <script src="{{ config('paths.adminlte_path') }}/plugins/jszip/jszip.min.js"></script>
    <script src="{{ config('paths.adminlte_path') }}/plugins/pdfmake/pdfmake.min.js"></script>
    <script src="{{ config('paths.adminlte_path') }}/plugins/pdfmake/vfs_fonts.js"></script>
    <script src="{{ config('paths.adminlte_path') }}/plugins/datatables-buttons/js/buttons.html5.min.js"></script>
    <script src="{{ config('paths.adminlte_path') }}/plugins/datatables-buttons/js/buttons.print.min.js"></script>
    <script src="{{ config('paths.adminlte_path') }}/plugins/datatables-buttons/js/buttons.colVis.min.js"></script>
    <script>
        $(function() {
            $("#example").DataTable({
                "responsive": true,
